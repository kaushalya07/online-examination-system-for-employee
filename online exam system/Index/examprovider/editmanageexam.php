  ...
  <head>
    ...
    <script>
      function enableButtons() {
        ...
        updateButton.disabled = checkedCount !== 1; // Enable Update button only if one exam is selected
          ...
          <div class="card">
            <?php
              ...
              if ($result->num_rows > 0) {
                ...
                echo '<div class="row">'; // Open the first row container
                while ($row = $result->fetch_assoc()) {
                  $examID = $row['ExamID'];
                  $examLink = $row['ExamLink'];

                  if ($counter > 0 && $counter % 3 == 0) {
                    echo '</div><div class="row">'; // Close and open new row
                  }
            ?>
                  <div class="file">
